            ...
            <table class="table">
                ...
                <tbody>
                    <tr v-for="(menu,m) in menus" :key="m">
                        <td>{{menu.name}}</td>
                        <td><b-form-checkbox v-model="menu.permission.read"></b-form-checkbox></td>
                        <td><b-form-checkbox v-model="menu.permission.write"></b-form-checkbox></td>
                    </tr>
                </tbody>
            </table>
            <div class="row mt-2 mb-2" v-if="menus.length>0">
                <div class="col-md-2 d-flex justify-content-between">
                    <b-button type="submit" variant="success" :disabled="isBusy">Submit</b-button>
...
export default {
    ...
    computed:{
        isBusy() { return this.$store.state.isBusy },
        isError(){
            ...
            result.map(m=>{
                        ...
                        this.menus.push({
                            ...
                            permission:{
                                ...
                                write:(permittedMenus[0])? permittedMenus[0].permission.write : false
                            }
