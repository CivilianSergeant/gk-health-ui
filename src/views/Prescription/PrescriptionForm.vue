      ...
      <div class="row">
       <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <div v-if="invoice">
            <a v-for="(d,i) in invoice.patientServiceDetails" :key="i">{{d.service.name}} <span>Status: {{ isPaid(d)}}</span></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3">
        ...
        <div class="row mt-1">
          <div class="col-md-9">
            ...
            <div class="d-flex flex-row justify-content-between">
              <b-form-checkbox class="mr-2" v-model="prescription.familyHistory.dm"> DM</b-form-checkbox>
              <b-form-checkbox class="mr-2" v-model="prescription.familyHistory.htn"> HTN</b-form-checkbox>
              
            </div>
            <div class="d-flex flex-row justify-content-between">
              <b-form-checkbox class="mr-2" v-model="prescription.familyHistory.asthma"> Br. Asthma</b-form-checkbox>
              <b-form-checkbox class="mr-2" v-model="prescription.familyHistory.tb"> TB</b-form-checkbox>
            </div>
            </b-form-group>
          </div>
        </div>
        ...
        <div class="row mt-1">
          <div class="col-md-12">
            ...
            >
            <b-form-textarea v-model="prescription.personalHistory.previousHistory"></b-form-textarea>
            </b-form-group>
          </div>
        </div>
        <div class="row mt-1">
          <div class="col-md-9">
            ...
            >
              ...
              <b-form-input  v-model="prescription.generalExamination.bloodPressure" />
              <label>Pulse</label>
              <b-form-input  v-model="prescription.generalExamination.pulse" />
              <label>Tempurature</label>
              <b-form-input  v-model="prescription.generalExamination.tempurature" />
              <label>Weight</label>
              <b-form-input  v-model="prescription.generalExamination.weight" />
            </b-form-group>
          </div>
        </div>
        <div class="row mt-1">
          <div class="col-md-9">
            ...
            >
              <b-textarea  id="pae" v-model="prescription.generalExamination.pae"/>
            </b-form-group>
          </div>
        </div>
