        ...
        <div class="col-md-3">
          ...
          <div class="row mt-1">
            <div class="col-md-9">
              ...
              >
                <div class="d-flex flex-row justify-content-between">
                  <b-form-checkbox v-model="prescription.personalHistory.dm">
                    DM</b-form-checkbox
                  >
                  <b-form-checkbox v-model="prescription.personalHistory.htn">
                    HTN</b-form-checkbox
                  >
                  <b-form-checkbox v-model="prescription.personalHistory.tb">
                    TB</b-form-checkbox
                  >
                </div>
                <div class="d-flex flex-row justify-content-between">
                  ...
                  >
                    Br. Asthma</b-form-checkbox
                  >
                  <b-form-checkbox v-model="prescription.personalHistory.pud">
                    PUD</b-form-checkbox
                  >
                </div>
              </b-form-group>
          ...
          <table class="table">
            <thead>
              <tr class="bg-light">
                ...
                <th>
                  <a @click="addMedicine" v-if="patient" class="anchorBtn"
