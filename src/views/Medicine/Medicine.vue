<template>
    <div>
        ...
        <h5 class="clearfix">All Medicines
            <router-link to="/medicines/add" class=" btn btn-primary btn-sm float-right">Add Medicine</router-link >
        </h5>
      <b-form-group
          label="Filter"
      ...
      :filter-included-fields="filterOn"
        :current-page="currentPage" :items="medicines">
...
export default {
    ...
    data(){
        return{
            ...
            medicineGroups:[],
            medicineBrands:[],
            form:{name:'',active:true,medicineGroup:{id:null},medicineBrand:{id:null}},
            filter: null,
            filterOn: [],
            totalRows:0
        }
